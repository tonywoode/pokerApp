...
public interface ISpeechRecoGrammar extends Com4jObject {
 ...
 ISpeechRecoContext recoContext();
   ...
   * </p>
   * @param state MandatorySpeechGrammarState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of typeSpeechGrammarState
   */
 ...
 SpeechGrammarState state();
   ...
   * </p>
   * @return  Returns a value of typeISpeechGrammarRules
   */
 ...
 ISpeechGrammarRules rules();
  ...
  @VTID(11)
  @ReturnValue(defaultPropertyThrough={ISpeechGrammarRules.class})
 ISpeechGrammarRule rules(
    int index);
  ...
  void cmdLoadFromFile(
    ...
    @Optional @DefaultValue("0")SpeechLoadOption loadOption);
   ...
   * @param state MandatorySpeechRuleState parameter.
   */
   ...
   * @param info MandatoryISpeechTextSelectionInformation parameter.
   */
   ...
   * @return  Returns a value of typeSpeechWordPronounceable
   */

  @DISPID(19) //= 0x13. The runtime will prefer the VTID if present
  @VTID(25)
 SpeechWordPronounceable isPronounceable(
