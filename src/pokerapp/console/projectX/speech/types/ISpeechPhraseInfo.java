...
public interface ISpeechPhraseInfo extends Com4jObject {
 ...
 ISpeechPhraseProperty properties(
   ...
   * </p>
   * @return  Returns a value of typeISpeechPhraseElements
   */
 ...
 ISpeechPhraseElements elements();
  ...
  @VTID(16)
  @ReturnValue(defaultPropertyThrough={ISpeechPhraseElements.class})
 ISpeechPhraseElement elements(
    int index);
   ...
   * </p>
   * @return  Returns a value of typeISpeechPhraseReplacements
   */
 ...
 ISpeechPhraseReplacements replacements();
  ...
  @VTID(17)
  @ReturnValue(defaultPropertyThrough={ISpeechPhraseReplacements.class})
 ISpeechPhraseReplacement replacements(
    int index);
   ...
   * @param elements Optional parameter. Default value is -1
   * @param useReplacements Optional parameter. Default value is false
   * @return  Returns a value of typeSpeechDisplayAttributes
   */

  @DISPID(16) //= 0x10. The runtime will prefer the VTID if present
  @VTID(22)
 SpeechDisplayAttributes getDisplayAttributes(
    @Optional @DefaultValue("0") int startElement,
    @Optional @DefaultValue("-1") int elements,
    @Optional @DefaultValue("-1") boolean useReplacements);
