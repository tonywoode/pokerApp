...
public interface ISpVoice extends ISpEventSource {
  // Methods:
  /**
 ...
 ISpObjectToken getVoice();
  ...
  int speakStream(
   IStream pStream,
    ...
    /**
     * @param ePriority MandatorySPVPRIORITY parameter.
     */
    ...
    /**
     * @return  Returns a value of typeSPVPRIORITY
     */

    @VTID(25)
   SPVPRIORITY getPriority();


    /**
     * @param eBoundary MandatorySPEVENTENUM parameter.
     */
    ...
    /**
     * @return  Returns a value of typeSPEVENTENUM
     */

    @VTID(27)
   SPEVENTENUM getAlertBoundary();
