...
public interface ISpeechRecognizer extends Com4jObject {
   ...
   * </p>
   * @param recognizer MandatoryISpeechObjectToken parameter.
   */
 ...
 ISpeechObjectToken recognizer();
  ...
  @VTID(11)
  void audioInput(
    @Optional @DefaultValue("0")ISpeechObjectToken audioInput);
 ...
 ISpeechObjectToken audioInput();
  ...
  void audioInputStream(
    @Optional @DefaultValue("0")ISpeechBaseStream audioInputStream);
 ...
 ISpeechBaseStream audioInputStream();
   ...
   * </p>
   * @param state MandatorySpeechRecognizerState parameter.
   */
   ...
   * </p>
   * @return  Returns a value of typeSpeechRecognizerState
   */
 ...
 SpeechRecognizerState state();
   ...
   * </p>
   * @return  Returns a value of typeISpeechRecognizerStatus
   */
 ...
 ISpeechRecognizerStatus status();
  ...
  @VTID(19)
  void profile(
    @Optional @DefaultValue("0")ISpeechObjectToken profile);
 ...
 ISpeechRecoContext createRecoContext();
   ...
   * GetFormat
   * </p>
   * @param type MandatorySpeechFormatType parameter.
   * @return  Returns a value of typeISpeechAudioFormat
   */

  @DISPID(11) //= 0xb. The runtime will prefer the VTID if present
  @VTID(23)
 ISpeechAudioFormat getFormat(
  ...
  @VTID(30)
 ISpeechObjectTokens getRecognizers(
  ...
  @VTID(31)
 ISpeechObjectTokens getAudioInputs(
    @Optional @DefaultValue("") java.lang.String requiredAttributes,
    @Optional @DefaultValue("") java.lang.String optionalAttributes);
  ...
  @VTID(32)
 ISpeechObjectTokens getProfiles(
    @Optional @DefaultValue("") java.lang.String requiredAttributes,
    @Optional @DefaultValue("") java.lang.String optionalAttributes);
