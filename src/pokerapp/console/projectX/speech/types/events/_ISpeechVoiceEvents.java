...
import com4j.*;
import pokerapp.console.projectX.speech.types.ISpeechObjectToken;
import pokerapp.console.projectX.speech.types.SpeechVisemeFeature;
import pokerapp.console.projectX.speech.types.SpeechVisemeType;
...
public abstract class _ISpeechVoiceEvents {
   ...
   * @param streamNumber Mandatory int parameter.
   * @param streamPosition Mandatory java.lang.Object parameter.
   * @param voiceObjectToken MandatoryISpeechObjectToken parameter.
   */
  ...
  public void voiceChange(
    int streamNumber,
    java.lang.Object streamPosition,
   ISpeechObjectToken voiceObjectToken) {
        throw new UnsupportedOperationException();
  }
   ...
   * @param feature MandatorySpeechVisemeFeature parameter.
   ...
   * @param streamPosition Mandatory java.lang.Object parameter.
   * @param duration Mandatory int parameter.
   * @param nextVisemeId MandatorySpeechVisemeType parameter.
   * @param feature MandatorySpeechVisemeFeature parameter.
   * @param currentVisemeId MandatorySpeechVisemeType parameter.
   */
