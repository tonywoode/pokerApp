...
public interface ISpeechLexicon extends Com4jObject {
   ...
   * @return  Returns a value of typeISpeechLexiconWords
   */

  @DISPID(2) //= 0x2. The runtime will prefer the VTID if present
  @VTID(8)
 ISpeechLexiconWords getWords(
    @Optional @DefaultValue("3")SpeechLexiconType flags,
  ...
  void addPronunciation(
    ...
    int langId,
    @Optional @DefaultValue("0")SpeechPartOfSpeech partOfSpeech,
 ...
 ISpeechLexiconPronunciations getPronunciations(
    ...
    @Optional @DefaultValue("3")SpeechLexiconType typeFlags);
  ...
  @VTID(14)
 ISpeechLexiconWords getGenerationChange(
