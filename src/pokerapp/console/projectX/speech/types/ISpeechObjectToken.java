...
public interface ISpeechObjectToken extends Com4jObject {
   ...
   * </p>
   * @return  Returns a value of typeISpeechDataKey
   */
 ...
 ISpeechDataKey dataKey();
   ...
   * </p>
   * @return  Returns a value of typeISpeechObjectTokenCategory
   */
 ...
 ISpeechObjectTokenCategory category();
  ...
  com4j.Com4jObject createInstance(
    ...
    @Optional @DefaultValue("23")SpeechTokenContext clsContext);
   ...
   * @param folder MandatorySpeechTokenShellFolder parameter.
   * @return  Returns a value of type java.lang.String
   */
