...
public class FilteredHandRunner {
  ...
  public static void main(String[] args) { //TODO this doesn't run anyhow - remove now?
    try {
  ...
  public void run() {
    final JFrame frame = new JFrame("Load Image Sample"); //TODO is this test code does it belong here?
...
/**
 * helper for cloning images for applying a filter to them
 * code from http://stackoverflow.com/questions/3514158/how-do-you-clone-a-bufferedimage
 * @param img a buffered image
 * @return the colourmodel, raster and alpha premultiplied status of the image passed in
 */
